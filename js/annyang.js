...
(function (undefined) {
   ...
   */
   ...
   var initIfNeeded = function(options) {
      // console.log(options);
      if (!isInitialized()) {
   ...
   root.annyang = {
      ...
      */
      init: function(commands, resetCommands) {
         ...
         recognition.onresult  = function(event) {
            ...
            // console.log(SpeechRecognitionResult); // return list of possible matched texts
            var results = [];
      ...
      */
      start: function(options) {      
         ...
         if (options  !== undefined && options != "") {
            console.log("Create websocket connection to " + options);
      ...
      *
      * Alternatively, to only temporarily pause annyang responding to commands without stopping the SpeechRecognitionResult engine or closing the mic, use pause() instead.
      * @see [pause()](#pause)
      *
      * @method abort
      */
